TranslationsEN = {
        ...
        random_vehicle_swapping = 'Random vehicle swapping',
        random_vehicle_categories = 'Swap categories',
        random_vehicle_categories_hint = 'Enable the vehicle categories that can be chosen during lap swaps.',
        random_vehicle_category_required = 'Enable at least one swap category for random vehicle swapping.',
        random_no_same_vehicle = 'No same vehicle',
        random_no_same_vehicle_hint = "Don't swap into the exact same vehicle the racer is currently driving.",
        random_no_same_category = 'No same category',
        random_no_same_category_hint = "Don't swap into a vehicle from the same category as the current ride.",
        random_unique_category = 'Unique category per race',
        random_unique_category_hint = 'Each category can be used once per race. Resets after every category has been used.',
        random_shared_categories = 'Same categories, varied order',
        random_shared_categories_hint = 'Every racer cycles through the same enabled categories but in their own shuffled order, with a random vehicle pick within each.',
        hosted_by = "Hosted by",
        hosting = "Hosting",
